...
class AttandeeSettingsScreen extends StatefulWidget {
  const AttandeeSettingsScreen({super.key});

  @override
  State<AttandeeSettingsScreen> createState() => _AttandeeSettingsScreenState();
}

class _AttandeeSettingsScreenState extends State<AttandeeSettingsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        title: 'attendee.settings.title'.tr(),
        showBackButton: true,
      ),
