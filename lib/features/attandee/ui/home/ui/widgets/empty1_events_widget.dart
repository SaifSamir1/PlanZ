...
class Empty1EventsWidget extends StatelessWidget {
  ...
  const Empty1EventsWidget({super.key, required this.filterType});
        ...
        child: Column(
          ...
          children: [
            ...
            OutlinedButton.icon(
              ...
              icon: Icon(Icons.mail_rounded, color: AppColors.buttonPrimary),
              label: Text(
    ...
    switch (filter) {
      case EventFilter.all:
        return _EmptyConfig(
          ...
          title: 'attendee.my_events_empty_all_title'.tr(),
          message: 'attendee.my_events_empty_all_message'.tr(),
        );
      case EventFilter.upcoming:
        return _EmptyConfig(
          icon: Icons.event_available_rounded,
          title: 'attendee.empty_events_title'.tr(),
          message: 'attendee.my_events_empty_upcoming_message'.tr(),
        );
      case EventFilter.past:
        return _EmptyConfig(
          icon: Icons.history_rounded,
          title: 'attendee.my_events_empty_past_title'.tr(),
          message: 'attendee.my_events_empty_past_message'.tr(),
        );
    }
  }
}
