...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    ...
    debugPrint('💳 [PaymentScreen] initState:');
    debugPrint('   eventId: ${widget.eventId}');
    debugPrint('   totalAmount: ${widget.totalAmount}');
    debugPrint('   _depositAmount: $_depositAmount');
    _loadEventData();
  }

  /// ✅ Load Event Data
  void _loadEventData() {
    debugPrint('💳 [PaymentScreen] Loading event data for payment: ${widget.eventId}');
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Row(
                        children: [
                          Icon(Icons.event, size: 16, color: AppColors.primaryGold),
                          const SizedBox(width: 8),
                          Expanded(
                            child: Text(
                              event.eventName,
