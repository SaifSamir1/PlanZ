...
import 'package:plan_z/features/event_owners/chat_bot/ui/widgets/chat_welcome_widget.dart';
import 'package:plan_z/features/event_owners/chat_bot/ui/widgets/chat_loading_widget.dart';
import 'package:plan_z/features/event_owners/chat_bot/ui/widgets/chat_content_widget.dart';
import 'package:plan_z/features/event_owners/chat_bot/ui/widgets/chat_error_widget.dart';
import 'package:plan_z/features/event_owners/chat_bot/ui/widgets/scroll_to_bottom_fab.dart';
        ...
        builder: (context, state) {
          if (state is ChatWelcome) {
            return ChatWelcomeWidget(
              onStart: () => context.read<ChatCubit>().startChat(),
            );
            ...
            return ChatErrorWidget(
              ...
              onRetry: () => context.read<ChatCubit>().resetChat(),
            );
          }
          return const SizedBox.shrink();
        },
