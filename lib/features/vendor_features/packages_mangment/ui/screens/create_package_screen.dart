...
// class CreatePackageScreen extends StatefulWidget {
//   final bool isEdit; // ✅ للتفريق بين Add و Edit
//   final PackageModel? package; // ✅ Package للتعديل
...
//   late List<String> _featuresAr;
//   late List<String> _keywords;
//   late List<PortfolioItem> _portfolioLinks;

//   // Available Services (Mock - replace with real data)
//   final List<Map<String, String>> _availableServices = [
//     {'id': 'catering', 'name': 'Catering', 'nameAr': 'تقديم الطعام'},
//     {
//       'id': 'photography',
//       'name': 'Photography',
//       'nameAr': 'التصوير الفوتوغرافي',
//     },
//     {'id': 'decoration', 'name': 'Decoration', 'nameAr': 'الديكور'},
//     {'id': 'transportation', 'name': 'Transportation', 'nameAr': 'النقل'},
...
//   /// Load Package Data (في حالة Edit)
//   void _loadPackageData() {
//     if (widget.isEdit && widget.package != null) {
//       final package = widget.package!;
...
//       _packageNameArController.text = package.packageNameAr;
//       _descriptionController.text = package.description;
//       _descriptionArController.text = package.descriptionAr;
//       _priceController.text = package.price.toString();

//       // Set Selected Values
//       _selectedServiceId = package.serviceId;
//       _selectedServiceName = package.serviceName;
//       _selectedServiceNameAr = package.serviceNameAr;
//       _selectedCurrency = package.currency;
//       _selectedPriceUnit = package.priceUnit;

//       // Set Lists
//       _features = List<String>.from(package.features);
//       _featuresAr = package.featuresAr != null
//           ? List<String>.from(package.featuresAr!)
//           : [];
//       _keywords = List<String>.from(package.keywords);
//       _portfolioLinks = List<PortfolioItem>.from(package.portfolioLinks);
//     }
...
//   /// Submit Package (Create or Update)
//   void _submitPackage() {
...
//           packageNameAr: _packageNameArController.text.trim(),
//           description: _descriptionController.text.trim(),
//           descriptionAr: _descriptionArController.text.trim(),
//           price: double.parse(_priceController.text.trim()),
//           features: _features,
//           featuresAr: _featuresAr.isEmpty ? null : _featuresAr,
//           keywords: _keywords,
//           portfolioLinks: _portfolioLinks,
//         );
//       } else {
...
//       appBar: CustomAppBar(title: widget.isEdit ? 'Edit Package' : 'Create Package'),
//       body: BlocListener<VendorCubit, VendorState>(
//         listener: (context, state) {
//           if (state is CreatePackageSuccess) {
//             ScaffoldMessenger.of(context).showSnackBar(
...
//                     isEditMode: widget.isEdit, // ✅ Disable في Edit Mode
//                     onServiceSelected: (serviceId, serviceName, serviceNameAr) {
//                       setState(() {
//                         _selectedServiceId = serviceId;
//                         _selectedServiceName = serviceName;
//                         _selectedServiceNameAr = serviceNameAr;
//                       });
//                     },
//                   ),
...
//                     packageNameArController: _packageNameArController,
//                     descriptionController: _descriptionController,
...
//                     selectedPriceUnit: _selectedPriceUnit,
//                     isEditMode:
//                         widget.isEdit, // ✅ Disable Currency/Unit في Edit Mode
//                     onCurrencyChanged: (currency) {
//                       setState(() => _selectedCurrency = currency!);
//                     },
//                     onPriceUnitChanged: (unit) {
...
//                     onAddFeature: (feature, featureAr) {
//                       setState(() {
//                         _features.add(feature);
//                         if (featureAr.isNotEmpty) _featuresAr.add(featureAr);
//                       });
//                     },
//                     onRemoveFeature: (index) {
//                       setState(() {
//                         _features.removeAt(index);
//                         if (_featuresAr.length > index) {
...
//                     portfolioLinks: _portfolioLinks,
//                     onAddLink: (link) {
//                       setState(() => _portfolioLinks.add(link));
//                     },
//                     onRemoveLink: (index) {
//                       setState(() => _portfolioLinks.removeAt(index));
//                     },
//                   ),
//                   const SizedBox(height: 32),
...
//     return AppBar(
//       title: Text(
//         widget.isEdit ? 'Edit Package' : 'Create Package', // ✅ Dynamic Title
...
//         children: [
//           const SizedBox(height: 12),
//           if (isEditMode && selectedServiceId != null)
//             // ✅ Show selected service in Edit Mode (non-editable)
//             Container(
//               padding: const EdgeInsets.all(16),
//               decoration: BoxDecoration(
...
//               child: Row(
//                 children: [
//                   Icon(Icons.lock, color: AppColors.primaryGold, size: 20),
//                   const SizedBox(width: 12),
//                   Text(
...
// // ============================================
// // 2. Package Details Section Widget
// // ============================================
...
//     required this.packageNameArController,
//     required this.descriptionController,
...
//           const SizedBox(height: 16),
//           _CustomTextField(
//             controller: packageNameArController,
//             label: 'Package Name (Arabic)',
//             hint: 'مثال: باقة الزفاف المميزة',
//             icon: Icons.card_giftcard_rounded,
//             textDirection: TextDirection.rtl,
//             validator: (value) {
//               if (value == null || value.trim().isEmpty) {
//                 return 'Please enter package name in Arabic';
//               }
//               return null;
//             },
//           ),
...
// // ============================================
// // 3. Pricing Section Widget
// // ============================================
// class _PricingSection extends StatelessWidget {
//   final TextEditingController priceController;
//   final String selectedCurrency;
//   final String selectedPriceUnit;
//   final bool isEditMode; // ✅ Disable Currency/Unit في Edit Mode
...
//                   label: 'Currency',
//                   value: selectedCurrency,
//                   items: ['EGP', 'USD', 'EUR', 'SAR'],
//                   onChanged: isEditMode ? null : onCurrencyChanged, // ✅ Disable
//                 ),
//               ),
//             ],
//           ),
...
//             items: ['per_event', 'per_person', 'per_hour', 'per_day'],
//             displayNames: {
//               'per_event': 'Per Event',
...
//               'per_day': 'Per Day',
//             },
//             onChanged: isEditMode ? null : onPriceUnitChanged, // ✅ Disable
//           ),
//         ],
//       ),
//     );
...
// // ============================================
// // 4. Features Section Widget (Same as before)
// // ============================================
// class _FeaturesSection extends StatelessWidget {
//   final List<String> features;
//   final List<String> featuresAr;
//   final Function(String, String) onAddFeature;
//   final Function(int) onRemoveFeature;
...
//                 labelText: 'Feature (English)',
//                 hintText: 'e.g., Professional photographer',
//               ),
//             ),
//             const SizedBox(height: 12),
//             TextField(
...
//               decoration: const InputDecoration(
//                 labelText: 'Feature (Arabic)',
//                 hintText: 'مثال: مصور محترف',
//               ),
//               textDirection: TextDirection.rtl,
//             ),
//           ],
...
//           ElevatedButton(
//             onPressed: () {
//               if (enController.text.trim().isNotEmpty) {
//                 onAddFeature(
...
//   const _FeatureChip({required this.feature, required this.onDelete});
...
//                 return _KeywordChip(
//                   keyword: entry.value,
//                   onDelete: () => onRemoveKeyword(entry.key),
//                 );
//               }).toList(),
//             ),
//           const SizedBox(height: 12),
...
//                 onAddKeyword(controller.text.trim());
//                 Navigator.pop(context);
//               }
//             },
//             style: ElevatedButton.styleFrom(
...
// // ============================================
// // 6. Portfolio Section Widget (Same as before)
// // ============================================
// class _PortfolioSection extends StatelessWidget {
//   final List<PortfolioItem> portfolioLinks;
//   final Function(PortfolioItem) onAddLink;
...
//   Widget build(BuildContext context) {
//     return _SectionContainer(
//       title: 'Portfolio Links (Google Drive)',
//       child: Column(
//         children: [
//           const SizedBox(height: 12),
//           if (portfolioLinks.isNotEmpty)
//             ...portfolioLinks.asMap().entries.map((entry) {
//               return _PortfolioLinkCard(
//                 item: entry.value,
//                 onDelete: () => onRemoveLink(entry.key),
//               );
//             }).toList(),
//           const SizedBox(height: 12),
//           _AddItemButton(
...
// class _PortfolioLinkCard extends StatelessWidget {
//   final PortfolioItem item;
//   final VoidCallback onDelete;

//   const _PortfolioLinkCard({required this.item, required this.onDelete});
...
// // ============================================
// // 7. Submit Button Widget
// // ============================================
// class _SubmitButton extends StatelessWidget {
//   final bool isEditMode;
//   final VoidCallback onPressed;

//   const _SubmitButton({required this.isEditMode, required this.onPressed});
...
//   final ValueChanged<String?>? onChanged; // ✅ Nullable للـ Disable
